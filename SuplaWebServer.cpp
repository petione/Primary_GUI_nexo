...
String SuplaWebServer::supla_webpage_start(int save) {
  ...
  //content += F("<font size='2'>RSSI: " + read_rssi() + "</font>");
...
String SuplaWebServer::SuplaMetas() {
  return F("<!DOCTYPE HTML>\n<meta http-equiv='content-type' content='text/html; charset=UTF-8'>\n<meta name='viewport' content='width=device-width,initial-scale=1,maximum-scale=1,user-scalable=no'>\n");
}

String SuplaWebServer::SuplaStyle() {
  if (ConfigESP->configModeESP == NORMAL_MODE) {
...
String SuplaWebServer::SuplaFavicon() {
...
String SuplaWebServer::SuplaLogo() {
...
String SuplaWebServer::SuplaJavaScript() {
...
String SuplaWebServer::SuplaCopyrightBar() {
